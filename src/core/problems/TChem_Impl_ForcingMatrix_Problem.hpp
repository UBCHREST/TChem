...
===================================================================================== */
#ifndef __TCHEM_IMPL_FORCING_MATRIX_PROBLEM_HPP__
#define __TCHEM_IMPL_FORCING_MATRIX_PROBLEM_HPP__

#include "TChem_Util.hpp"

#include "TChem_Impl_SourceTermWithModification.hpp"
...
struct ForcingMatrix_Problem
{
  ...
  {
    const ordinal_type src_workspace_size = SourceTermWithModification::getWorkSpaceSize(kmcd);
  ...
  {
    Impl::SourceTermWithModification::team_invoke(member, x, _temp, _p, _Ys, f, _work, _kmcd);
    member.team_barrier();
  }
