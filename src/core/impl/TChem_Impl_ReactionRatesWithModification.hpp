...
===================================================================================== */
#ifndef __TCHEM_IMPL_REACTIONRATESWITHMODIFICATION_HPP__
#define __TCHEM_IMPL_REACTIONRATESWITHMODIFICATION_HPP__
...
struct ReactionRatesWithModification
{
  ///
    ...
    const KineticModelConstDataType& kmcd)
  {
    ...
    if (member.league_rank() == 0) {
      FILE* fs = fopen("ReactionRatesWithModification.team_invoke.test.out", "a+");
      fprintf(fs, ":: ReactionRatesWithModification::team_invoke\n");
      fprintf(fs, ":::: input\n");
      fprintf(fs,
