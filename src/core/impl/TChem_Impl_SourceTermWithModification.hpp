...
===================================================================================== */
#ifndef __TCHEM_IMPL_SOURCE_TERM_WITHMODIFICATION_HPP__
#define __TCHEM_IMPL_SOURCE_TERM_WITHMODIFICATION_HPP__

#include "TChem_Impl_CpMixMs.hpp"
#include "TChem_Impl_EnthalpySpecMs.hpp"
#include "TChem_Impl_MolarConcentrations.hpp"
#include "TChem_Impl_ReactionRatesWithModification.hpp"
...
struct SourceTermWithModification
{
    ...
    const KineticModelConstDataType& kmcd)
  {
    ...
    ReactionRatesWithModification::team_invoke_detail(member,
                                       alpha,
                                       t,
                                       p,
                                       Ys,
